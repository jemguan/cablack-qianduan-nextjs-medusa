  ...
  return (
    <div className="product-page-constraint">
      <div className="flex flex-col gap-8 items-center text-center mb-8">
        <div className="w-20 h-6 animate-pulse bg-muted rounded"></div>
        <div className="flex flex-col gap-4 items-center text-center mb-16">
          <div className="w-96 h-10 animate-pulse bg-muted rounded"></div>
          <div className="w-48 h-10 animate-pulse bg-muted rounded"></div>
        </div>
      </div>
