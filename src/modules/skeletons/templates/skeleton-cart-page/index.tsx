    ...
    <div className="py-12">
      <div className="content-container">
        <div className="grid grid-cols-1 small:grid-cols-[1fr_360px] gap-x-40">
          <div className="flex flex-col bg-card border border-border rounded-lg p-6 gap-y-6 shadow-sm">
            <div className="flex items-start justify-between">
              <div className="flex flex-col gap-y-2">
                <div className="w-60 h-8 bg-muted animate-pulse rounded" />
                <div className="w-48 h-6 bg-muted animate-pulse rounded" />
              </div>
              <div>
                <div className="w-14 h-8 bg-muted animate-pulse rounded" />
              </div>
            </div>
            <div>
